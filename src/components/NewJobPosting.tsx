...
export default function NewJobPosting (){
    ...
    const [jobReqQualHtml, setJobReqQualHtml] = useState('');
    ...
    const postJobPosting = () => {
        let jobPostingData = {
            ...
            "jobDesc": jobDescHtml,
            "jobResp": jobRespHtml,
            "jobReqQual": jobReqQualHtml,
            "hardToFillRole": prioJobPosting
        }

        handleClose();

        console.log("data: ", jobPostingData)
    }
    ...
    <Col md={4}>
        <Card className='job-posting-card'>
            <Card.Body>
                ...
                <Card.Text className='text-center'>
                    <PlusCircleDotted onClick={handleShow} style={{fontSize:'150px', marginTop:'12px', color:'#7a7a7aff', cursor:'pointer'}}/>
                </Card.Text>
            </Card.Body>
        </Card>
        ...
        centered>
            ...
            <Modal.Body>
                ...
                <DefaultEditor value={jobDescHtml} onChange={(e) => setJobDescHtml(e.target.value)} />

                <Form.Label>Responsibilities:</Form.Label>
                <DefaultEditor value={jobRespHtml} onChange={(e) => setJobRespHtml(e.target.value)} />

                <Form.Label>Requirements and Qualifications:</Form.Label>
                <DefaultEditor value={jobReqQualHtml} onChange={(e) => setJobReqQualHtml(e.target.value)} />
            </Modal.Body>
            <Modal.Footer>
                <Form.Check
                    style={{margin: '0 auto'}}
