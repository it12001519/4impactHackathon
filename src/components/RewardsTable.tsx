        ...
        <div className="draggable" style={{padding: '20px 20px 10px 20px'}}>
            <Table hover borderless striped className="text-center">
                ...
                <tbody>
                    <tr>
                        <td>John Doe</td>
                        <td className="d-none d-xl-table-cell"><span className="badge bg-success">50 Pts</span></td>
                    ...
                    <tr>
                        <td>Mark Santos</td>
                        <td className="d-none d-xl-table-cell"><span className="badge bg-success">50 Pts</span></td>
                        <td className="d-none d-xl-table-cell">Passed Technical Interview</td>
                    </tr>
                    <tr>
                        <td>Mark Santos</td>
                        <td className="d-none d-xl-table-cell"><span className="badge bg-success">50 Pts</span></td>
                        <td className="d-none d-xl-table-cell">Passed Client Interview</td>
                    </tr>
                    <tr>
                        <td>Troy Smith</td>
                        <td className="d-none d-xl-table-cell"><span className="badge bg-success">50 Pts</span></td>
