      ...
      <Row>
        <Col md={4}>
          <Card className="box-shadow admin-reports" border="light">
            <Card.Body>
              <Card.Title className="admin-report-title">
                Reward Points Given <WalletFill style={{ float: "right" }} />
              </Card.Title>
        ...
        <Col md={4}>
          <Card className="box-shadow admin-reports" border="light">
            <Card.Body>
              <Card.Title className="admin-report-title">
                Monthly Referred Candidates{" "}
                <FileEarmarkFill style={{ float: "right" }} />
              </Card.Title>
          ...
          <Card className="box-shadow admin-reports" border="light">
            <Card.Body>
              <Card.Title className="admin-report-title">
                ...
                <PersonCheckFill style={{ float: "right" }} />
              </Card.Title>
