        ...
        <Col md={3}>
          <Card className="employee-profile box-shadow" border="light">
              <Card.Body className="text-center">
                  <Card.Img variant='top' src='https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava6.webp'
                  alt='avatar'
              ...
              <Card.Footer>
                  <Card.Text><EnvelopeAt style={{marginRight: '15px'}} /> admin@4impact.com.au</Card.Text>
                ...
                <Col md={4}>
                    <Card className='job-posting-card'>
                        <Card.Body>
                            ...
                            <ViewJobStatus jobTitle='Software Engr. Intern' jobId='JP331' />
